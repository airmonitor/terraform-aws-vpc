...
output "public_db_subnet_ids" {
  value       = aws_subnet.db_subnet_public.*.id
  description = "The IDs of the database public subnets."
}

output "public_db_subnet_arns" {
  value       = aws_subnet.db_subnet_public.*.arn
  description = "The ARNs of the database public subnets."
}

output "public_db_subnet_cidr_blocks" {
  value       = aws_subnet.db_subnet_public.*.cidr_block
  description = "The CIDR blocks for the database public subnets."
}
...
output "public_db_subnet_grup_name" {
  value = aws_db_subnet_group.db_subnet_group_public.*.name
}

output "private_db_subnet_grup_name" {
