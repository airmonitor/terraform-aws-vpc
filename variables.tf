...
variable "public_db_subnet_cidr_blocks" {
  default     = []
  type        = list(string)
...
variable "peer_vpc_id" {
  default     = []
  type        = list(string)
  description = "The target - peer VPC ID's list to which peering will be established"
}
...
variable "enabled_vpc_peering" {
  default     = true
  type        = string
  description = "Set to false to prevent the module from creating VPC Peering"
}